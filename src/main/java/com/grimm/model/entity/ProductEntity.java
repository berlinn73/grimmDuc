...
public class ProductEntity {
    ...
    public ProductEntity(Integer id, String tenSanPham, String hinhAnh, String thongTinChiTiet, Integer giaBan, Integer soLuong, String mauSac, String size, String tag, String trangThai, LocalDate ngayDang, Integer idMenuCon) {
        this.id = id;
