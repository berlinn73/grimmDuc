                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <input type="text" class="form-control" id="userName" name="userName"
                                       placeholder="Tài khoản" value=${userResponse.userName}>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                <input type="password" class="form-control" id="password" name="password"
                                       placeholder="Mật khẩu" value=${userResponse.password}>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                <input type="text" class="form-control" id="phone" name="phone"
                                       placeholder="Số điện thoại" value=${userResponse.phone}>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-group">
                                    ...
                                    <c:if test="${not empty userResponse.roleId}">
                                        <c:forEach var="item" items="${role}">
                                            <option value="${item.id}" <c:if
                                                    test="${item.id == userResponse.roleId}"> selected value</c:if> >${item.name}</option>
                                        </c:forEach>
                                    </c:if>
                                </select>
                            </div>
