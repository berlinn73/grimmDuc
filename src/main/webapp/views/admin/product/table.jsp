                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Table Product With Full Features</h3>
                        </div><!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <%--                                insert--%>
                                <th>
                                    <a float flag="info" class="btn-group-vertical" data-toggle="tooltip" title='Thêm sản phẩm' href='<c:url value="/admin-table-product?type=edit"/>'>
                                        <span>
                                ...
                                <th>
                                    <%--                                delete--%>
                                    <a class="btn-group-vertical" id="btnDelete" data-toggle="tooltip" title="Xóa sản phẩm">
                            ...
                            <c:forEach var="item" items="${model.listResult}">
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <a class="btn-group-vertical" data-toggle="tooltip" title="Sua" href="${edit}">
